 ...
 */
public class Bolt5_SignificantUsers extends UDFBoltTest implements UDFBoltTestMethods
{

    public Bolt5_SignificantUsers(String testName, OperatorTest opTest)
    {
        super(testName, opTest, new Fields("user_id", "total_significance"));
    }
