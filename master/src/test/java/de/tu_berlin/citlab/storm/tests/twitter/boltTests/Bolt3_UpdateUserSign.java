 ...
 */
public class Bolt3_UpdateUserSign extends UDFBoltTest implements UDFBoltTestMethods
{

    public Bolt3_UpdateUserSign(String testName, OperatorTest opTest)
    {
        super(testName, opTest, new Fields("user_id", "word", "id", "significance"));
    }
